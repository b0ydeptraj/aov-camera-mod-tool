# vietnamese-product-localization Battle Contract

Primary role: localization
...
- Repo profile: public docs repo with README, localized docs, static GitHub catalog, and encoding tests
- First files to inspect: README.md, README.vi.md, docs/site/index.md, tests/test_readme_encoding.py
- Symbols or named surfaces to confirm: test_readme_files_are_utf8_without_mojibake, render_battle_audit
- Evidence terms that should appear in a strong answer: utf-8, public copy, overclaim, evidence label
