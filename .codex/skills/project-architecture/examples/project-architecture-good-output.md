# project-architecture Battle-Calibrated Output

Request: audit a Relay-kit runtime change and prove the generated surfaces are still synchronized

Recommended skill: `project-architecture` because the request matches `architecture-support` work and has concrete repo anchors.
