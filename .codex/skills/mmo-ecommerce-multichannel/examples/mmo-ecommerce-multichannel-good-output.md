# mmo-ecommerce-multichannel Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-ecommerce-multichannel` because the request matches `mmo-ecommerce-ops` work and has concrete repo anchors.
