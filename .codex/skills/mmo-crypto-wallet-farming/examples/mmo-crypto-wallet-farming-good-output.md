# mmo-crypto-wallet-farming Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-crypto-wallet-farming` because the request matches `mmo-crypto-farming` work and has concrete repo anchors.
