# execution-loop Battle-Calibrated Output

Request: audit a Relay-kit runtime change and prove the generated surfaces are still synchronized

Recommended skill: `execution-loop` because the request matches `developer-support` work and has concrete repo anchors.
