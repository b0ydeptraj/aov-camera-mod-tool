# mmo-nick-warmup-engine Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-nick-warmup-engine` because the request matches `mmo-nick-warmup` work and has concrete repo anchors.
