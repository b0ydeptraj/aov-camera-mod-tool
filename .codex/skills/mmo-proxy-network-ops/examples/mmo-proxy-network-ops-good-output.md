# mmo-proxy-network-ops Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-proxy-network-ops` because the request matches `mmo-proxy-ops` work and has concrete repo anchors.
