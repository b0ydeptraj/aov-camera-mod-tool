# delegation-control Battle-Calibrated Output

Request: audit a Relay-kit runtime change and prove the generated surfaces are still synchronized

Recommended skill: `delegation-control` because the request matches `utility-provider` work and has concrete repo anchors.
