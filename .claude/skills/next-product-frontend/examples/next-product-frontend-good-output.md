# next-product-frontend Battle-Calibrated Output

Request: review a login UI change, name files first, and identify the test evidence before editing

Recommended skill: `next-product-frontend` because the request matches `next-frontend` work and has concrete repo anchors.
