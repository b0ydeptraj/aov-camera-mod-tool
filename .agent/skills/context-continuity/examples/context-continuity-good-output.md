# context-continuity Battle-Calibrated Output

Request: audit a Relay-kit runtime change and prove the generated surfaces are still synchronized

Recommended skill: `context-continuity` because the request matches `utility-provider` work and has concrete repo anchors.
