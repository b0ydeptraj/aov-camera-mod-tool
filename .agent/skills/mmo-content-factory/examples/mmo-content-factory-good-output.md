# mmo-content-factory Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-content-factory` because the request matches `mmo-content-ops` work and has concrete repo anchors.
