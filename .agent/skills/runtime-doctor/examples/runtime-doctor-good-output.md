# runtime-doctor Battle-Calibrated Output

Request: plan an operational automation change with rollback and dry-run evidence before enabling it

Recommended skill: `runtime-doctor` because the request matches `utility-provider` work and has concrete repo anchors.
