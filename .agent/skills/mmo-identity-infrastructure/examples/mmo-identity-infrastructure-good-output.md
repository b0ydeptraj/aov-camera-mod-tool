# mmo-identity-infrastructure Battle-Calibrated Output

Request: review an operator-owned MMO automation lane for safety, repeatability, and evidence logging

Recommended skill: `mmo-identity-infrastructure` because the request matches `mmo-identity-infrastructure` work and has concrete repo anchors.
